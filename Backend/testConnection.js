...
console.log("🔍 Attempting to connect with URI:", uri ? uri.replace(/:([^@]+)@/, ":****@") : "❌ MONGO_URI is undefined!");

if (!uri) {
  console.error("❌ MONGO_URI is not set in .env file. Check your Backend/.env file exists.");
  process.exit(1);
}
