  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-black text-primary tracking-tight">Event Details</h1>
      </div>
      ...
      <div className="bg-white rounded-[2rem] overflow-hidden shadow-xl shadow-slate-200/60 border border-slate-100 mb-10">
        <div className="relative h-72 md:h-80 lg:h-96">
          ...
          <div className="absolute top-6 left-6 flex items-center gap-3">
            <span className="inline-flex items-center px-3 py-1 rounded-full bg-accent text-accent-foreground text-xs font-black uppercase tracking-widest shadow-lg">
              Upcoming
            </span>
            <span className="inline-flex items-center px-3 py-1 rounded-full bg-white/10 border border-white/20 text-[0.65rem] font-bold uppercase tracking-widest text-white">
              {evt.date} • {evt.time}
            </span>
          </div>
          <div className="absolute bottom-8 left-6 right-6">
            <h2 className="text-3xl md:text-4xl font-black text-white leading-tight mb-2 drop-shadow-md">
              {evt.name}
            </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] gap-8 items-start">
        <div className="bg-white rounded-3xl shadow-lg shadow-slate-200/50 border border-border p-6 md:p-8">
          <h3 className="mb-4 text-xl font-black text-primary tracking-tight">About This Event</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 p-6 bg-muted rounded-2xl border border-border">
            <div>
              <div className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-1">Date</div>
              <div className="font-semibold text-primary">{evt.date}</div>
            </div>
            <div>
              <div className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-1">Time</div>
              <div className="font-semibold text-primary">{evt.time}</div>
            </div>
            <div className="sm:col-span-2">
              <div className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-1">Location</div>
        ...
        <div className="space-y-6">
          <div className="bg-primary rounded-3xl text-primary-foreground p-6 md:p-7 shadow-2xl border border-slate-900/40 sticky top-4">
            <h3 className="text-sm font-black uppercase tracking-widest text-primary-foreground/70 mb-2">Stall Booking Overview</h3>
          ...
          <div className="bg-white rounded-3xl border border-border p-5 shadow-sm">
            <h4 className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-3">Booking Flow</h4>
            <ol className="space-y-2 text-xs text-muted-foreground font-medium">
