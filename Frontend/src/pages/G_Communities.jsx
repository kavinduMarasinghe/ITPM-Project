...
export default function Communities() {
  ...
  const societyCards = useMemo(() => {
    return allSocieties.map((society) => {
      ...
      const societyEvents = allEvents.filter((event) => {
        const eventSocietyId = getId(event.societyId);
        return eventSocietyId === societyId;
      });
                ...
                <CardContent className="p-6 space-y-5">
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <Button
                        variant="outline"
                        onClick={() => navigate(`/update-society/${societyId}`)}
                      >
                        Update Society
                      </Button>
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {(society.members || []).map((member) => member.name).join(", ")}
                    </div>
                  </div>
                  ...
                  {isExpanded && (
                    <div className="border-t pt-5 space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <CreateEventDialog preSelectedSocietyId={societyId} />
                      </div>
                                ...
                                <div className="min-w-0">
                                  <div className="flex items-center gap-2 flex-wrap">
                                    ...
                                    {userRole && (
                                      ...
                                      >
                                        {memberRoleLabels[userRole] || userRole}
                                      </Badge>
                                    )}
                                  </div>
